...
const unsigned DATE_SIZE = 11;
const unsigned LOSE_WEIGHT = 1;
const unsigned KEEP_WEIGHT = 2;
const unsigned GAIN_WEIGHT = 3;
const unsigned SLOW_SPEEDTOWEIGHT = 0.25;
const unsigned MEDIUM_SPEEDTOWEIGHT = 0.5;
const unsigned HIGH_SPEEDTOWEIGHT = 0.75;
const unsigned VERY_HIGH_SPEEDTOWEIGHT = 1.0;
const unsigned CALORIES_PER_KG_FOR_WEEK = 1100;
...
const char WORKOUT_DIFFERENTIATOR = 'w';
const char MEAL_DIFFERENTIATOR = 'm';
const std::string ALLPROFILES = "allProfiles.txt";
const std::string TXT = ".txt";
const std::string DATEFILE = "date";
